...
const CategoryGroupTemplate = ({ handleCloseTemplateDetailsModal, page_id }: CategoryGroupTemplateProps) => {
  const { watch, control, setValue, handleAddNewCategory, handleRemoveCategory, handleFileChange, collectionOptions, handleSave, isCreating } = useCategoryGroupTemplate({ handleCloseTemplateDetailsModal, page_id })
  return (
